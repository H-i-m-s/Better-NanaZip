...
void ExtractArchives(const UStringVector &arcPaths, const UString &outFolder, bool showDialog, bool elimDup, UInt32 writeZone, bool smartExtract = false, bool openFolder = false, UInt32 overwriteMode = (UInt32)(Int32)-1, bool waitFinish = false, bool suppressDelete = false, bool useDlgState = false, const UString &releaseBeforeDeleteMarker = UString(), const UString &passwordSessionId = UString());
